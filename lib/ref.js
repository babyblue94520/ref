    ...
    var RefValue = /*@__PURE__*/(function (Ref) {
        ...
        RefValue.prototype.set = function set (value, operator) {
            ...
            if ((((_a = this.operators) === null || _a === void 0 ? void 0 : _a.length) || 0) > 0 && this.operators.indexOf(operator) == -1) {
                var message = 'The operator does\'t settable!';
         ...
         */
        RefValue.prototype.setOperators = function setOperators () {
            var operators = [], len = arguments.length;
            while ( len-- ) operators[ len ] = arguments[ len ];

            var _a;
            if ((((_a = this.operators) === null || _a === void 0 ? void 0 : _a.length) || 0) > 0) {
                var message = 'Cannot set operators again!';
